...
public class PropertiesPanel extends JPanel {
    ...
    public void setProperties(JComponent comp) {
        ...
        colorTypeLabel.setText(comp.getBackground().getRed() + " " + comp.getBackground().getGreen() + " "
                + comp.getBackground().getBlue());
    }
    ...
    private class ColorActionListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            colorTypeLabel.setText(item.getBackground().getRed() + " " + item.getBackground().getGreen() + " "
                    + item.getBackground().getBlue());
        }
    }
